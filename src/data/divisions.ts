...
const group1: DivisionItem[] = [
    {
        ...
        img: '/ikons/dg-thumbnail.png',
        icon: '/ikons/dg-icon.png',
        color: 'green'
    },
    {
        id: 2,
        ...
        img: '/ikons/fg-thumbnail.png',
        icon: '/ikons/fg-icon.png',
        color: 'cyan'
    },
    {
        id: 3,
        ...
        img: '/ikons/wm-thumbnail.png',
        icon: '/ikons/wm-icon.png',
        color: 'pink'
    },
    {
        id: 4,
        ...
        img: '/ikons/cw-thumbnail.png',
        icon: '/ikons/cw-icon.png',
        color: 'red'
    }
]
...
const group2: DivisionItem[] = [
    {
        ...
        img: '/ikons/rp-thumbnail.png',
        icon: '/ikons/rp-icon.png',
        color: 'purple'
    },
    {
        id: 2,
        ...
        img: '/ikons/vg-thumbnail.png',
        icon: '/ikons/vg-icon.png',
        color: 'yellow'
    },
    {
        id: 3,
        ...
        img: '/ikons/il-thumbnail.png',
        icon: '/ikons/il-icon.png',
        color: 'blue'
    },
    {
        id: 4,
        ...
        img: '/ikons/pk-thumbnail.png',
        icon: '/ikons/pk-icon.png',
        color: 'orange'
    }
]
