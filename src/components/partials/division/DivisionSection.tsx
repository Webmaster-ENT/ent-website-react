...
import DivisionAccordionList from "./DivisionAccordionList";
...
export default function DivisionSection() {
  ...
  const [activeAccordionMobile, setActiveAccordionMobile] = useState<
    number | null
  >(1);

  return (
    <section
      className="relative w-full min-h-screen flex flex-col items-center justify-start my-32"
      id="division"
    >
      ...
      <div className="flex md:hidden flex-col px-5 space-y-6 mb-10">
        ...
        <p className="w-full max-w-4xl text-base text-balance">
          ENT is the Journalism and Network Team responsible for managing the
          official media accounts of Politeknik Elektronika Negeri Surabaya
          (PENS). It has the posibility to work for content, news, and video
          needs. We can help in terms of brainstorming, technical execution, to
      ...
      <div className="realtive md:hidden px-5 my-20">
        ...
        <h1 className="text-6xl font-medium text-pretty leading-none">
          Where Learning Spirit And Passion Meet
        </h1>
      </div>
      ...
      <div className="flex max-md:px-5 flex-col items-center space-y-6 md:space-y-10">
        ...
        <h1 className="font-medium max-md:hidden text-6xl md:text-center leading-snug">
          Let&apos;s Dive In Deeper <br />
          Get To Know The Divisions
        </h1>
        ...
        <p className="w-full max-w-4xl md:text-center text-base md:text-lg">
          To support the needs, in the ENT student unit there are divisions that
          will work according to their expert fields. What divisions are there
          in ENT? Let&apos;s find out!
        </p>
      </div>
      ...
      <div className="mt-24 flex md:hidden flex-col justify-center items-center w-full gap-5">
        <DivisionAccordionList
          ...
          onToggle={(id) =>
            setActiveAccordionMobile(activeAccordionMobile === id ? null : id)
          }
        />
      </div>
    </section>
